...
public class ListenerWD implements WebDriverListener {
    ...
    public void onError(Object target, Method method, Object[] args, InvocationTargetException e) {
        ...
        logger.info("Test ends with error");
        logger.info("===================================");
        logger.info("Method name--> " + method.getName());
        logger.info("===================================");
        //logger.info("InvocationTargetException message"+e.getMessage());   null
        //logger.info("===================================");
        //logger.info("InvocationTargetException target-->"+e.getTargetException());
        //logger.info("===================================");
